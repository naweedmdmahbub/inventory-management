<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link v-if="checkPermission(['manage structure type'])" to="/project/structures/create">
        <el-button
    ...
    >
      ...
      <el-table-column align="center" label="Actions">
        <template slot-scope="scope">
          <router-link v-if="checkPermission(['manage structure type'])" :to="'/project/structures/view/'+scope.row.id">
            <el-button
              v-permission="['manage structure type']"
              type="warning"
              size="small"
          ...
          <router-link v-if="checkPermission(['manage structure type'])" :to="'/project/structures/edit/'+scope.row.id">
            <el-button
              v-permission="['manage structure type']"
              type="primary"
              size="small"
...
export default {
  ...
  methods: {
    ...
    handleDelete(id, name) {
      this.$confirm('This will permanently delete Structure ' + name + '. Continue?', 'Warning', {
        confirmButtonText: 'OK',
        cancelButtonText: 'Cancel',
        type: 'warning',
      }).then(() => {
        structureResource.destroy(id).then(response => {
          this.$message({
            type: 'success',
