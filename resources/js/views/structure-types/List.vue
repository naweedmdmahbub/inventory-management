<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link v-if="checkPermission(['manage structure type'])" to="/project/structure-types/create">
        <el-button
    ...
    >
      ...
      <el-table-column align="center" label="Actions">
        <template slot-scope="scope">          
          ...
          <router-link v-if="checkPermission(['manage structure type'])" :to="'/project/structure-types/edit/'+scope.row.id">
            <el-button
              v-permission="['manage structure type']"
              type="primary"
              size="small"
...
const structureTypeResource = new Resource('structureTypes');
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      this.loading = true;
      const { data, meta } = await structureTypeResource.list(this.query);
      this.list = data;
    ...
    handleDelete(id, name) {
      this.$confirm('This will permanently delete structureType ' + name + '. Continue?', 'Warning', {
        ...
        structureTypeResource.destroy(id).then(response => {
          this.$message({
            type: 'success',
